...
(function($){
	$.cookieBar = function(options,val){
		...
		var defaults = {
			message: 'Utilizamos cookies para conocer cómo te mueves por la web. Si aceptas o continuas navegando, entendemos que estás de acuerdo con su uso.', //Message displayed on bar
			...
			policyURL: '/politica-cookies.html', //URL of Privacy Policy
